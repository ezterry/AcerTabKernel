...
int acer_t20_charge_init(void);
int acer_t20_regulator_init(void);
...
#define TEGRA_GPIO_SPKR_EN		VENTANA_GPIO_WM8903(0)
#define TEGRA_GPIO_SPKR_MUTE		VENTANA_GPIO_WM8903(2)
#else
#define TEGRA_GPIO_SPKR_EN		VENTANA_GPIO_WM8903(2)
#endif
#define TEGRA_GPIO_HP_DET		TEGRA_GPIO_PW2
#define TEGRA_GPIO_INT_MIC_EN		VENTANA_GPIO_WM8903(1)
#define TEGRA_GPIO_EXT_MIC_EN		TEGRA_GPIO_PX1
#define TEGRA_GPIO_DEBUG_SWITCH_EN	TEGRA_GPIO_PR2
