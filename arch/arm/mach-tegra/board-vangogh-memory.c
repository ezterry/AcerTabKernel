...
static const struct tegra_emc_table vangogh_emc_tables_elpida_8Gb_300Mhz[] = {
	{
...
static const struct tegra_emc_table vangogh_emc_tables_elpida_4Gb_300Mhz[] = {
	{
		.rate = 25000,   /* SDRAM frequency */
		.regs = {
			0x00000002,   /* RC */
...
static const struct tegra_emc_table vangogh_emc_tables_Hynix_4Gb_300Mhz[] = {
	{
		.rate = 25000,   /* SDRAM frequency */
		.regs = {
			0x00000002,   /* RC */
...
static const struct tegra_emc_table vangogh_emc_tables_Hynix_8Gb_300Mhz[] = {
	{
		.rate = 25000,   /* SDRAM frequency */
		.regs = {
			0x00000002,   /* RC */
...
int acer_t20_emc_init(void)
{
	switch (RAM_CODE) {
	case 0:
		tegra_init_emc(vangogh_emc_tables_elpida_8Gb_300Mhz, ARRAY_SIZE(vangogh_emc_tables_elpida_8Gb_300Mhz));
		break;
	case 1:
