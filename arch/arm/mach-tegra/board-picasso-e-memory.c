...
static const struct tegra_emc_table picasso_e_emc_tables_elpida_8Gb_300Mhz[] = {
	{
...
static const struct tegra_emc_table picasso_e_emc_tables_Hynix_8Gb_300Mhz[] = {
	{
		.rate = 25000,   /* SDRAM frequency */
		.regs = {
			0x00000002,   /* RC */
...
int acer_t20_emc_init(void)
{
	...
	printk("################ Picasso-E RAMCODE =%d #################\n", strap);
	switch (strap) {
	case 0:
		pr_info("%s: Elpida 8GB memory found\n", __func__);
		tegra_init_emc(picasso_e_emc_tables_elpida_8Gb_300Mhz,
			ARRAY_SIZE(picasso_e_emc_tables_elpida_8Gb_300Mhz));
		break;
	case 3:
		pr_info("%s: Hynix 8GB memory found\n", __func__);
		tegra_init_emc(picasso_e_emc_tables_Hynix_8Gb_300Mhz,
			ARRAY_SIZE(picasso_e_emc_tables_Hynix_8Gb_300Mhz));
		break;
	default:
