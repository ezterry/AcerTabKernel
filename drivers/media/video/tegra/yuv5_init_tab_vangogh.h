...
{WRITE_REG_DATA8,  0xD00E, 0x1E  },	// PGA_ZONE_LOW_1 -- low limit for middle CT condition, i.e. CWF or TL84
{WRITE_REG_DATA8,  0xD00F, 0x69  },	// PGA_ZONE_LOW_2 -- low limit for higher CT condition, i.e. D65 or DNP
{WRITE_REG_DATA8,  0xD011, 0x1D  },	// PGA_ZONE_HIGH_0 -- high limit for low CT condition, i.e. A-light
{WRITE_REG_DATA8,  0xD012, 0x68  },	// PGA_ZONE_HIGH_1 -- high limit for middle CT condition, i.e. CWF or TL84
...
{WRITE_REG_DATA8,  0xD00C, 0x02  },	// PGA_NO_OF_ZONES
{WRITE_REG_DATA16, 0xD006, 0x0100},	// PGA_ZONE_ADDR_0
{WRITE_REG_DATA16, 0xD008, 0x0200},	// PGA_ZONE_ADDR_1
{WRITE_REG_DATA16, 0xD002, 0x8007},	// PGA_ALGO
{WRITE_REG_DATA8,  0xD00D, 0x00  },	// PGA_ZONE_LOW_0
{WRITE_REG_DATA8,  0xD00E, 0x69  },	// PGA_ZONE_LOW_1
{WRITE_REG_DATA8,  0xD011, 0x68  },	// PGA_ZONE_HIGH_0
{WRITE_REG_DATA8,  0xD012, 0x7F  },	// PGA_ZONE_HIGH_1
{SENSOR_5M_TABLE_END, 0x0000, 0x0000}
};
...
{WRITE_REG_DATA8,  0xACB2, 0x41  },	// AWB_RG_MIN_BRIGHT
{WRITE_REG_DATA8,  0xACB3, 0x43  },	// AWB_RG_MAX_BRIGHT
{WRITE_REG_DATA8,  0xACB6, 0x4E  },	// AWB_BG_MIN_BRIGHT
{WRITE_REG_DATA8,  0xACB7, 0x50  },	// AWB_BG_MAX_BRIGHT
{WRITE_REG_DATA16, 0xACB8, 0x0032},	// AWB_START_NUM_INT_LINES
{WRITE_REG_DATA16, 0xACBA, 0x000A},	// AWB_END_NUM_INT_LINES
...
{WRITE_REG_DATA16, 0xB842, 0x0040},	// STAT_AWB_GRAY_CHECKER_OFFSET_X
{WRITE_REG_DATA16, 0xB844, 0x0041},	// STAT_AWB_GRAY_CHECKER_OFFSET_Y
// -- Rev1, 02232011, Alias
...
{WRITE_REG_DATA16, 0x301A, 0x1074},	// color dot workaround
...
{WRITE_REG_DATA16, 0xA81A, 0x0848},	// AE_TRACK_MAX_INT_TIME_ROWS fix 15 fps
...
{WRITE_REG_DATA16, 0x3E2E, 0xEA19},	// Samp_Spare, substrate switch for BH
{WRITE_REG_DATA16, 0x3EE6, 0xA5C0},	// Dac_Ld_26_27
{WRITE_REG_DATA16, 0x316C, 0xB430},	// 0xB430 (txlo=0 at low gain) for reddish issue workaround LFW ~3000e-
...
{WRITE_REG_DATA16, 0xC854, 0x09F0},	// CAM_CORE_A_FINE_ITMIN
...
{WRITE_REG_DATA16, 0xC8AA, 0x0320},	// CAM_OUTPUT_0_IMAGE_WIDTH  = 800
{WRITE_REG_DATA16, 0xC8AC, 0x0258},	// CAM_OUTPUT_0_IMAGE_HEIGHT = 600
...
{WRITE_REG_DATA8,  0xA409, 0x2B  },	// AE_RULE_BASE_TARGET
{SENSOR_5M_TABLE_END, 0x0000, 0x0000}
};

static struct sensor_reg exp_negative1[] = {
{WRITE_REG_DATA16, 0x098E, 0x1000},	// LOGICAL_ADDRESS_ACCESS [AE_RULE_BASE_TARGET]
{WRITE_REG_DATA8,  0xA409, 0x35  },	// AE_RULE_BASE_TARGET
{SENSOR_5M_TABLE_END, 0x0000, 0x0000}
};
...
{WRITE_REG_DATA16, 0x098E, 0x1000},	// LOGICAL_ADDRESS_ACCESS [AE_RULE_BASE_TARGET]
{WRITE_REG_DATA8,  0xA409, 0x45  },	// AE_RULE_BASE_TARGET
{SENSOR_5M_TABLE_END, 0x0000, 0x0000}
};
